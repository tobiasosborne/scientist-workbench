...
| 086 | `bench/` → corpus migration: linalg trio (eigh + qr + svd) + ODE trio (ivp + stiff + symplectic) + real-root-isolate + poly-roots-radical + alg-num-arith + poly-factor-q shipped; ~179 MB + ~4.3 MB + ~72 KB + ~480 KB + ~108 KB + ~124 KB freed (ADR-0028, spup Pillar 2); poly-roots-radical surfaced & fixed a canonicalisePolyTerms ascending-sort bug in packages/poly-factor | 2026-05-10 | scientist-workbench-{uh2d, annr, dx0l, g6dn, ifng, yj80, 3pby, x18p, 5usl, 41yl} (all closed); eigh 46/46, qr 56/56, svd 56/56, ivp 17/17, stiff 19/19, symplectic 17/17, real-root-isolate 37/37, poly-roots-radical 50/50, alg-num-arith 32/32, poly-factor-q 56/56 cases (all invariants pass); poly-factor-q corpus@df86f3b |
