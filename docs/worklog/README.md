...
| 086 | `bench/` → corpus migration: linalg trio (eigh + qr + svd) + ODE trio (ivp + stiff + symplectic) + real-root-isolate + poly-roots-radical + alg-num-arith + poly-factor-q + linsolve-q + solve + hypergeometric-pfq shipped; ~179 MB + ~4.3 MB + ~72 KB + ~480 KB + ~108 KB + ~124 KB + ~220 KB + ~152 KB + ~104 KB freed (ADR-0028, spup Pillar 2); poly-roots-radical surfaced & fixed a canonicalisePolyTerms ascending-sort bug in packages/poly-factor; solve grades 94/100 with 6 pre-existing transcendental-lane drifts (3g9x; blocks b55); hypergeometric-pfq is first arbprec-tier migration (platform_pinned=false; verify.ts self-contained on @workbench/bigfloat at 128 dps, no Python runtime) | 2026-05-10 | scientist-workbench-{uh2d, annr, dx0l, g6dn, ifng, yj80, 3pby, x18p, 5usl, 41yl, mnnm, upaz, 5gg5} (all closed; 3g9x open tracks the 6 transcendental-lane drift cases — blocks b55; si37 open tracks corpus schema extension for structured [meta.known_failures]); eigh 46/46, qr 56/56, svd 56/56, ivp 17/17, stiff 19/19, symplectic 17/17, real-root-isolate 37/37, poly-roots-radical 50/50, alg-num-arith 32/32, poly-factor-q 56/56, linsolve-q 46/46, solve 94/100, hypergeometric-pfq 53/53 cases (all-handled-lanes invariants pass; rand-trans-{002,004,006,008,009,013} fail honestly); hypergeometric-pfq corpus@86001e5 |
