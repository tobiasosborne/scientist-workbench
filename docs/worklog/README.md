...
| 086 | `bench/` → corpus migration: linalg trio (eigh + qr + svd) + ODE trio (ivp + stiff + symplectic) + real-root-isolate shipped; ~179 MB + ~4.3 MB + ~72 KB freed (ADR-0028, spup Pillar 2) | 2026-05-09 | scientist-workbench-{uh2d, annr, dx0l, g6dn, ifng, yj80, 3pby} (all closed); eigh 46/46, qr 56/56, svd 56/56, ivp 17/17, stiff 19/19, symplectic 17/17, real-root-isolate 37/37 cases (185/185 invariants); real-root-isolate corpus@da1f791, workbench@2b9d655 |
