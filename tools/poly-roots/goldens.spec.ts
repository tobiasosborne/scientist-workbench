...
export const goldens: GoldenSpec[] = [
  ...
  { description: "deg-5 reducible: x⁵ − 2x − 1 = (x + 1)(x⁴ − x³ + x² − x − 1) ⟹ Ferrari + linear", input: inp(poly([1n, 5n], [-2n, 1n], [-1n, 0n])) },
  { description: "deg-5 irreducible Lehmer L(x) (totally real, 11th cyclotomic real subfield) ⟹ 5 Root[] values", input: inp(poly([1n, 5n], [1n, 4n], [-4n, 3n], [-3n, 2n], [3n, 1n], [1n, 0n])) },
  { description: "deg-5 irreducible x⁵ − x − 1 (1 real + 4 complex) ⟹ tagged complex-roots-not-yet-named", input: inp(poly([1n, 5n], [-1n, 1n], [-1n, 0n])) },
  { description: "deg-7 reducible: (x − 2)·Lehmer ⟹ linear root + 5 Root[] values", input: inp(expr("*", [expr("+", [sym("x"), int(-2n)]), poly([1n, 5n], [1n, 4n], [-4n, 3n], [-3n, 2n], [3n, 1n], [1n, 0n])])) },
