...
// there).
//
// Resolution of the worklog-075 / bead-6f8 floor (worklog 077)
// ------------------------------------------------------------
...
// no-op levels. See worklog 077 for the full diagnosis snapshot.
//
...
//
// Convergence test (Bailey §5 rigorous, post-worklog 077)
// -------------------------------------------------------
...
// approaches (worklog 077 dead-end; advertised 108 dps on
...
export function tanhSinhAdaptiveBF(
  ...
  // which was the v0.1 bug (worklog 075 / 077).
  ...
  for (let level = 2; level <= maxLevels && !evalBudgetHit; level++) {
    ...
    // gate. Worklog 077 dead-end: I tried `d ≤ -prec` first and got
