...
// NT (Nesterov-Todd 1997 / Todd-Toh-Tütüncü 1998) is the primary export.
// AHO (Alizadeh-Haeberly-Overton 1997) is kept as an alternative
// direction for sanity checks.
...
describe("SDP A/B: NT (primary) and AHO both converge", () => {
  test("NT converges to 30 in ≤ 12 iters", () => {
