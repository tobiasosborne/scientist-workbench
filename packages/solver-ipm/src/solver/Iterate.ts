// Mutable iterate state for the LP primal-dual barrier method.
// Carries the current point (x, y, s), residuals (rp, rd, rc),
// step (dx, dy, ds), Schur complement M with its Cholesky factor
// Lchol, and per-iteration scalars (μ, primalObj, dualObj, gap,
// regularisation jitters and bump counts).
