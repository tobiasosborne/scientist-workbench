// 6-flag / 11-status convergence test. Computes relative + absolute
// primal feasibility, relative + absolute dual feasibility, relative +
// absolute optimality-gap flags; the status code is derived from their
// conjunction plus iter / time / stall guards.
